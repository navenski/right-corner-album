...
class AlbumAdapter(private val viewModel: AlbumListViewModel, private val filePathProvider: FilePathProvider) : PagingDataAdapter<AlbumItem, AlbumItemViewHolder>(diffCallback) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AlbumItemViewHolder {
        return AlbumItemViewHolder(AlbumItemBinding.inflate(LayoutInflater.from(parent.context), parent, false),viewModel, filePathProvider)
    }
